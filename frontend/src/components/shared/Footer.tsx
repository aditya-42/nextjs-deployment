    ...
    <footer className="bg-gray-900 text-white py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand Info */}
          <div>
            <h2 className="text-2xl font-bold">Hire<span className="text-[#F83002]">Ease</span></h2>
            <p className="text-sm mt-2">
              Connecting talent with opportunity. Your dream job is just a click away.
            </p>
            <p className="text-sm mt-4">&copy; 2024 HireEase. All rights reserved.</p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              ...
              <li><Link href="/jobs" className="hover:text-gray-400">Browse Jobs</Link></li>
          ...
          <div>
            ...
            <p className="text-sm mt-2">Email: support@jobhunt.com</p>
