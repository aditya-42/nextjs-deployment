  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 px-6">
      <div className="bg-white shadow-lg rounded-2xl p-8 text-center max-w-md">
        ...
        <p className="text-gray-600 mt-2">Your company has been register successfully.</p>
        <p className="text-gray-600 mt-2">You will receive confirmation email shortly</p>
