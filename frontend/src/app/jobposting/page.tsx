...
//     try {
//       const response = await fetch('http://localhost:5001/api/recruiter/getAlljobs');
//       if (!response.ok) {
            ...
            <div className="font-sans container mx-auto mt-3 p-6 flex flex-col md:flex-row bg-gray-50 min-h-screen">
                ...
                <div className="w-full md:w-3/4">
                    ...
                    <div className="map-container w-full h-60 rounded-lg overflow-hidden mb-4 shadow-md">
                        <MapContainer center={mapCenter} zoom={4} className="w-full h-full">
                            <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
                            <Marker position={mapCenter}>
                                <Popup>Selected Location: {selectedLocation}</Popup>
                            </Marker>
